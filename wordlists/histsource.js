...
const words = [
  {
    front: "Förklara de fyra källkritiska kriterierna: <br><br>Beroende, Äkthet, Tid, Tendens",
    back: "<b>Beroende</b>: Fråga om källan bygger på andra källor eller om den är självständig. En källa som bara återberättar vad någon annan sagt är mindre säker.<br><br><b>Äkthet</b>: Fråga om källan är äkta eller falsk. Är dokumentet, föremålet eller berättelsen verkligen från den tid och person den utger sig för att vara?<br><br><b>Tid</b>: Fråga hur lång tid det gått mellan händelsen och när källan skapades. Ju närmare i tid, desto större chans att detaljer stämmer.<br><br><b>Tendens</b>: Fråga om källan försöker påverka oss eller vinkla informationen. En person kan ha egna intressen, vilja försvara sig själv eller få någon annan att framstå på ett visst sätt."
  },
  {
    front: "En soldat skriver i sin dagbok under första världskriget år 1916: <i>\"Vi har ont om mat och många är rädda, men befälen säger att segern är nära.\"</i><br><br>Resonera om källan utifrån de fyra källkritiska kriterierna.",
  ...
  {
    front: "En kung låter skriva en text på 1500-talet där det står att folket älskar honom och att hans beslut alltid är rättvisa.<br><br>Resonera om källan utifrån de fyra källkritiska kriterierna.",
  ...
  {
    front: "En kvinna intervjuas år 1985 om hur det var att arbeta i fabrik som barn år 1930.<br><br>Resonera om källan utifrån de fyra källkritiska kriterierna.",
  ...
  {
    front: "En affisch från andra världskriget visar glada soldater och säger att alla måste kämpa för nationens ära.<br><br>Resonera om källan utifrån de fyra källkritiska kriterierna.",
  ...
  {
    front: "En historiebok från år 2020 beskriver vikingatiden med hjälp av arkeologiska fynd, gamla texter och modern forskning.<br><br>Resonera om källan utifrån de fyra källkritiska kriterierna.",
  ...
  {
    front: "En pojke i ett ockuperat land skriver ett brev till sin kusin år 1943 och berättar att han är rädd, att det är ont om mat och att soldater patrullerar gatorna varje dag.<br><br>Resonera om källan utifrån de fyra källkritiska kriterierna.",
